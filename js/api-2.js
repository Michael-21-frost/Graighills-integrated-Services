/*
THIS API IS FOR THE GRAIGHILLS TECH SERVICE BOOKING FORM
...
document.getElementById('booking').addEventListener('submit', async (e) => {
    ...
    const projectDetails = document.getElementById('projectDescription').value;
    const preferredDate = document.getElementById('preferredDate').value;
    const additionalNotes = document.getElementById('additionalNote').value;
